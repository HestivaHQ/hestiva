...
export function AboutSection() {
  return (
    <section id="about" className="bg-secondary py-24" aria-labelledby="about-heading">
      <div className="mx-auto grid max-w-7xl gap-12 px-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        ...
        >
          ...
          <h2
            id="about-heading"
            className="mt-3 text-4xl font-semibold leading-tight text-foreground md:text-5xl"
          >
        ...
        <div className="grid gap-4 sm:grid-cols-3 lg:grid-cols-1">
          {[
            ...
            >
              <value.icon className="h-5 w-5 shrink-0 text-primary" aria-hidden="true" />
