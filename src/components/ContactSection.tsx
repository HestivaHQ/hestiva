      ...
      <div className="mx-auto max-w-5xl px-6">
        <div className="rounded-2xl bg-[#3B0F1A] px-7 py-14 text-center shadow-xl sm:px-12">
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link to="/quote" className="inline-flex items-center justify-center gap-2 rounded-lg bg-[#C9A45B] px-6 py-3 font-semibold text-[#3B0F1A] transition-colors hover:bg-[#D8B970] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#F5F1E8]">
              Request a Quote <ArrowRight className="h-4 w-4" aria-hidden="true" />
            </Link>
            <Link to="/contact" className="inline-flex items-center justify-center gap-2 rounded-lg border border-[#C9A45B]/60 px-6 py-3 font-semibold text-[#F5F1E8] transition-colors hover:bg-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#C9A45B]">
