...
export const servicePages: ServicePage[] = [
  ...
  createService(
    ...
    [
      ...
      "Cupboards needing attention",
      "Floors requiring a fresh clean",
      "Preparing the home before unpacking",
    ],
  ),
  createService(
    "move-out-cleaning",
    "Move-Out Cleaning",
    "Move-Out Cleaning",
    "Residential cleaning for a vacated home, based on the property condition and the agreed handover scope.",
    [
      "Empty-room cleaning",
      "Kitchen and bathroom cleaning",
      "Accessible cupboard cleaning",
      "Floors and general surfaces",
      "Selected appliance interiors as add-ons",
      "Handover-focused finishing",
    ],
    [
      "Cleaning after furniture removal",
      "Dust and marks in empty rooms",
      "Kitchen residue",
      "Bathroom build-up",
      "Preparing a property for handover",
    ],
  ),
  createService(
    "kitchen-cleaning",
    "Kitchen Cleaning",
    "Kitchen Cleaning",
    "Focused cleaning for the kitchen’s everyday surfaces, fittings and selected appliance interiors.",
    [
      "Worktops and splashbacks",
      "Sink and tap cleaning",
      "Cupboard exterior cleaning",
      "Floor cleaning",
      "Stovetop exterior cleaning",
      "Oven or fridge interiors when selected",
    ],
    [
      "Grease on suitable surfaces",
      "Food residue",
      "Marked cupboard fronts",
      "Busy cooking areas",
      "Appliance interiors needing an add-on clean",
    ],
  ),
  createService(
    ...
    "Bathroom Sanitisation",
    "Bathroom Cleaning",
    "Focused residential bathroom cleaning for fixtures, surfaces and frequently touched areas.",
    [
      "Toilet, basin and bath cleaning",
      "Shower surface cleaning",
      "Mirror and fixture cleaning",
      "Reachable tile and surface cleaning",
      "Floor cleaning",
      "Frequently touched area attention",
    ],
    [
      "Soap residue",
      "Water marks",
  ...
  createService(
    ...
    "Bedroom Cleaning",
    "Bedroom Cleaning",
    "Careful cleaning of bedrooms and their accessible everyday surfaces.",
    [
      "Dusting accessible furniture",
      "Vacuuming or floor cleaning",
      "Mirror cleaning",
      "General surface care",
      "Bed making when selected",
      "Linen changing when selected",
    ],
    [
      "Dust on furniture",
      "Floors needing attention",
      "Untidy presentation",
      "Busy family bedrooms",
      "Bed-making or linen-change needs",
    ],
  ),
  createService(
    ...
    "Living Area Cleaning",
    "Living Area Cleaning",
    "Residential cleaning for lounges, dining areas and other shared living spaces.",
    [
      "Dusting accessible surfaces",
      "Vacuuming rugs and floors",
      "Hard-floor cleaning",
      "General tidying",
      "Reachable décor surface care",
      "Presentation-focused finishing",
    ],
    [
      "High-traffic dust",
      "Footprints and everyday debris",
      "Shared spaces needing regular care",
      "Pet hair on accessible surfaces",
      "Untidy room presentation",
    ],
  ),
  createService(
    ...
    "Interior Window Cleaning",
    "Interior Windows",
    "Interior glass cleaning for safely reachable windows, mirrors and selected glass surfaces.",
    [
      "Interior window glass",
      "Reachable frames and sills",
      "Mirrors",
      "Selected glass doors",
  ...
  createService(
    ...
    "Laundry Folding",
    "Laundry Folding",
    "An optional household add-on for neatly folding clean, dry laundry supplied by the customer.",
    [
      "Folding clean dry clothing",
      "Grouping similar items",
      "Neat placement in an agreed area",
      "Towel folding",
      "Linen folding",
      "Basic organisation as agreed",
    ],
    [
      "Backlogged clean laundry",
      "Limited folding time",
      "Household linen needing organisation",
      "Busy family schedules",
      "Clothing awaiting neat placement",
    ],
  ),
  createService(
    "apartment-cleaning",
    "Apartment Cleaning",
    "Apartment Cleaning",
    "Residential cleaning shaped for apartments, flats and compact homes.",
    [
      "Kitchen and bathroom cleaning",
      "Bedroom and living-area cleaning",
      "Floor care",
      "Accessible surface dusting",
      "Balcony or patio when selected",
      "Apartment-specific add-ons",
    ],
    [
      "Compact high-use spaces",
      "Limited household time",
      "Balcony dust",
      "Shared living areas",
      "Routine apartment upkeep",
    ],
  ),
  createService(
    ...
    "Eco-Conscious Cleaning",
    "Eco-Conscious Cleaning",
    "A cleaning option that considers product choice and practical household preferences where suitable products are available.",
    [
      "Preference review before service",
      "Thoughtful product selection",
      "Measured product use",
      "Room ventilation where practical",
      "Surface-appropriate cleaning",
      "Clear communication about limitations",
    ],
    [
      "Sensitivity to strong fragrances",
      "Preference for considered product use",
      "Households seeking lower-impact choices",
      "Surface-specific product concerns",
      "Need for advance product discussion",
    ],
  ),
  createService(
    "cleaning-add-ons",
