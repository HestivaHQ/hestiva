...
import { buildHestivaOsQuotePayload, type QuoteFormSnapshot } from "./hestiva-os-contract";

function snapshot(overrides: Partial<QuoteFormSnapshot> = {}): QuoteFormSnapshot {
  return {
