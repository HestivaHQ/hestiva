...
export const Route = createFileRoute("/privacy")({
  ...
  head: () => {
    ...
    const description = "Learn how Hestiva Residential Cleaning collects, uses, protects and manages personal information in line with POPIA.";
    const path = "/privacy";
      ...
      <main>
        <header className="border-b border-[#C9A45B]/25 bg-[#F7F0E3] px-6 pb-20 pt-32 md:pb-24 md:pt-40">
          <div className="mx-auto max-w-6xl">
            ...
            <p className="mt-6 max-w-3xl text-lg leading-8 text-[#695E59]">This policy explains how Hestiva Residential Cleaning (“Hestiva”, “we”, “us” or “our”) handles personal information in accordance with South Africa’s Protection of Personal Information Act, 2013 (“POPIA”).</p>
        ...
        <article className="mx-auto max-w-4xl space-y-14 px-6 py-16 lg:py-24">
          <section><h2 className={headingClass}>Responsible party and Information Officer</h2><p className={paragraphClass}>Hestiva Residential Cleaning is the responsible party for personal information described in this policy. Our business address is 2962 Dunlin Drive, Riverlea, Johannesburg, 2093.</p><p className={paragraphClass}>Our Information Officer is <strong>Smangaliso Nkosi</strong>. POPIA access, correction, deletion, objection and other privacy requests should be sent to <a className="font-semibold text-[#5A1425] underline underline-offset-4" href="mailto:snkosi@hestiva.co.za">snkosi@hestiva.co.za</a>.</p></section>
          <section><h2 className={headingClass}>Information we collect and why</h2><p className={paragraphClass}>We collect information reasonably needed to answer enquiries, prepare quotations, arrange and deliver cleaning services, communicate with customers, protect customers and staff, resolve concerns and meet legal obligations. This may include contact details, service address, property and household information, cleaning requirements, scheduling details, access arrangements and communications with us.</p><p className={paragraphClass}>Please provide only information relevant to the quotation or service and obtain permission before giving us another person’s personal information. Do not send alarm codes, safe combinations, permanent key locations or unnecessary valuables information through a public website form, ordinary email or WhatsApp.</p></section>
          <section><h2 className={headingClass}>Service providers and international processing</h2><p className={paragraphClass}>Hestiva uses <strong>Cloudflare</strong> for website hosting and related infrastructure and <strong>Resend</strong> for transactional email delivery. We may also use other staff or service providers where reasonably necessary to operate the business and deliver services.</p><p className={paragraphClass}>Providers receive only information reasonably necessary for their authorised purpose. We do not sell personal information. Where a provider processes information outside South Africa, Hestiva will use an appropriate basis and safeguards required by POPIA.</p></section>
          <section><h2 className={headingClass}>Security and access information</h2><p className={paragraphClass}>We use reasonable technical and organisational safeguards appropriate to the information and risks involved, including restricting access to people who need information for their work and using reputable service providers.</p><p className={paragraphClass}>Temporary property-access information is used only for the agreed service, shared only with authorised people who need it, and deleted when it is no longer reasonably necessary. Customers should arrange a suitable handover method with Hestiva for sensitive access information.</p></section>
