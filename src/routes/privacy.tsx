      ...
      <main>
        <header className="border-b border-[#C9A45B]/25 bg-[#F7F0E3] px-6 pb-20 pt-32 md:pb-24 md:pt-40">
          <div className="mx-auto max-w-6xl">
            ...
            <p className="mt-6 max-w-3xl text-lg leading-8 text-[#695E59]">This policy explains how Homent Residential Cleaning (“Homent”, “we”, “us” or “our”) handles personal information in accordance with South Africa’s Protection of Personal Information Act, 2013 (“POPIA”).</p>
